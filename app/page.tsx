...
export default  function Home() {
  return (
      ...
      <div className="flex justify-center items-center lg:flex-row h-screen w-full relative flex-col px-4">


          <div className='relative flex-col gap-[1rem]  justify-center items-start flex w-full xl:w-[60%]'>
              ...
              <motion.span
                  ...
                  className='bg-clip-text font-bold text-6xl md:text-8xl text-transparent bg-no-repeat bg-gradient-to-r from-purple-500 via-violet-500 to-pink-500'>
                  HOUSE OF IDEAS
              </motion.span>

              <span>
                  <WordTransform className="font-bold text-6xl md:text-8xl" initialWord="WELCOME TO " transformedWord="E-JOURNAL"/>
              </span>
          </div>

          <div className=' flex flex-col justify-center items-center h-full      w-full   xl:w-[40%]'>
